...
import { PersonnelEditProps, PersonnelStoreProps } from '@/types';
...
export function Editform({ departments, personnel }: EditPersonelFormProps) {
    ...
    const { data, setData, errors, put, processing } = useForm<Required<PersonnelStoreProps>>({
        ...
        department: String(personnel.departments[0].id),
        email: personnel.email,
        dni: personnel.dni.split('-')[1],
        national_status: personnel.dni.split('-')[0],
