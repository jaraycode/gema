  ...
  return (
    <div className="w-full">
      <div className="flex items-center py-4">
        ...
        />
        <a href="/department/new" className="flex items-center justify-center p-3 bg-[#1E9483] text-white rounded-[20px] ml-auto mr-10 transition duration-200 hover:shadow hover:shadow-[#1E9483] w-55">
