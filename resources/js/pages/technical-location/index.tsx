...
import { ResponseHandlerProps, TechnicalLocationPaginatedProps } from '@/types';
            ...
            <div className="@container/main flex flex-1 flex-col gap-2">
                <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6">
                    <div className="mx-4 grid grid-cols-1 gap-4 md:mx-8">
                        ...
                        <Card className="bg-card text-card-foreground flex flex-col gap-6 rounded-lg border py-6 shadow-md">
                            <CardContent>
